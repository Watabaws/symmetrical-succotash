...
var getMed = function(){
    ...
    var upper = Math.floor((ages.length - 1) / 2);
    var lower = Math.ceil((ages.length - 1) /2);

    var medtotal = (ages[upper] + ages[lower]) / 2;
